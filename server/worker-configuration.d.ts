/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: af7ee3ace7fc07f0785c6acaec0f2796)
// Runtime types generated with workerd@1.20250712.0 2025-05-25 
declare namespace Cloudflare {
	interface Env {
		CHATBOT_TOOL_KV: KVNamespace;
		GROQ_API_KEY: string;
